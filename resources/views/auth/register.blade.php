                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cap" type="cap" class="form-control @error('cap') is-invalid @enderror" name="cap" value="{{ old('cap') }}" required autocomplete="cap">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                {{-- <input id="day_off" type="day_off" class="form-control @error('day_off') is-invalid @enderror" name="day_off" value="{{ old('day_off') }}" required autocomplete="day_off"> --}}
