                        ...
                        <div class="card h-100 r-15 overflow-hidden">
                            ...
                            <div class="d-flex flex-row">
                                ...
                                >
                                    ...
                                    >
                                        <div
                                            class="card h-100 r-15 overflow-hidden"
                                        >
                                            <div
                                                class="h-100 d-flex flex-column justify-content-between"
                                            >
                                                ...
                                                <div
                                                    v-show="dish.available"
                                                    class="w-75 mx-auto"
                                                >
                                                    <div
                                                        class="d-flex justify-content-center mt-2 mb-3 mx-1"
                                                    >
                                                        <counter-component
                                                            @passData="
                                                                updateCount
...
export default {
    ...
    methods: {
            ...
            if (dishQty > 0) {
                ...
                if (
                    ...
                    this.localStorageIndex =
                        Math.max(...cartItemsIndexesArray) + 1;
                ...
                this.key =
                    "user" + userId + "cartItem" + this.localStorageIndex;
        ...
        refreshCart() {
            ...
            let filteredValuesArray = valuesArray.filter((el) =>
                el.startsWith(this.user.id + "|")
            );
